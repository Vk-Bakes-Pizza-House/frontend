...
export default function ManageReviews() {
  ...
  // ✅ FIX — function now closes properly right after the if-block.
  //    Previously a stray "}" inside a // comment meant this never
  //    closed, so everything below (counts, avgRating, visible,
  //    FILTERS, and the entire JSX return) was nested INSIDE this
  //    function instead of inside ManageReviews — meaning
  //    ManageReviews itself never returned anything → blank page.
  ...
  // ── Everything below is now correctly part of ManageReviews ──
  const counts = {
  ...
  // ✅ This return now belongs to ManageReviews, not confirmDelete
  return (
    <div className="relative">
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white max-w-sm w-full rounded-2xl p-5 border border-stone-200 shadow-2xl">
